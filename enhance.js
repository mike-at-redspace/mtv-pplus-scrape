...
async function addColumns() {
    try {
        ...
        console.log(chalk.greenBright(`Output CSV file generated: ${chalk.whiteBright.bold('data.csv')} run ${chalk.whiteBright.bold('play.js')} to start scraping the target urls`));
    } catch (error) {
